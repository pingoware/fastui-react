  ...
  return (
    <header className="flex items-center justify-between mx-6 md:mx-14 py-4 text-white relative">
      <div className="flex items-center space-x-4">
        ...
        <div className="cursor-pointer block md:hidden" onClick={toggleMenu}>
      ...
      <div className="flex-grow flex justify-center">
        <nav className="hidden md:flex space-x-6">
          ...
          <a className="hover:text-gray-400" href="mailto:contact@pingoware.tech">Contact</a>
        </nav>
      </div>
      ...
      <div className={`fixed top-0 left-0 h-full w-64 bg-gray-800 z-50 transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
        <div className="flex flex-col p-6 space-y-4">
          ...
          <a className="hover:text-gray-400" href="mailto:contact@pingoware.tech" onClick={toggleMenu}>Contact</a>
        </div>
      </div>
    </header>
  );
